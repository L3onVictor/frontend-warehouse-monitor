...
import { listarAmbientes, type Ambiente } from "@/services/api";
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400">Gerencie suas preferências de notificações e alertas.</p>
        </div>
        ...
        {success && (
          <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex gap-3 animate-in fade-in">
            ...
            <p className="text-sm text-green-700 dark:text-green-200">Preferências salvas com sucesso!</p>
          </div>
        )}
